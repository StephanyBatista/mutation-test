...
var log = log4js.getLogger('TempFolder');
var TempFolder = /** @class */ (function () {
     ...
     */
    TempFolder.prototype.writeFile = function (filename, data) {
    ...
    TempFolder.prototype.clean = function () {
        ...
        return fileUtils_1.deleteDir(this.baseTempFolder)
            .catch(function () { return log.info("Failed to delete stryker temp folder " + _this.baseTempFolder); });
    };
    /**
